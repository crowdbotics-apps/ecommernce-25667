"""ecommernce_25667 URL Configuration
...
admin.site.site_header = "ecommernce"
admin.site.site_title = "ecommernce Admin Portal"
admin.site.index_title = "ecommernce Admin"

# swagger
api_info = openapi.Info(
    title="ecommernce API",
    default_version="v1",
    description="API documentation for ecommernce App",
)
